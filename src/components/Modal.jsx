...
const LoginModal = () => {
    return (
        <>
            <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="bg-opacity-70 bg-black justify-center items-center flex  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
